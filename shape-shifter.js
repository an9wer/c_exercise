...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      var now = new Date()
      var nextyear = new Date(2021, 0, 1, 0, 0, 0, 0);
      var secondsLeft = Math.floor((nextyear.getTime() - now.getTime()) / 1000);
      console.log(secondsLeft);
      if (secondsLeft < 0) {
        S.UI.simulate('Happy 2021');
      } else {
        S.UI.simulate('#countdown ' + secondsLeft + '|Happy 2021');
      }
    }
